...
def run(mera_params, model, tensors=None):
    """
    Runs the MERA.
    """

    """
    0. Initialize tensors if they are not provided
    """
    d = mera_params['d']
    ...
    """
    1. Perform variational optimization rounds
    """
    # Set parameters
    ...
    """
    2. Compute conformal data from optimized MERA and return the results
    """
    ...
    point = {
        ...
        'checkpoint_data': {'chi': chi, 'iters': iters, 'layers': layers}
    }
