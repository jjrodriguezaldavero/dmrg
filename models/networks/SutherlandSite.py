"""
Definition of the Quantum Torus Chain - Sutherland sites.
"""
...
class SutherlandSite(Site):
    ...
    def __init__(self, conserve="Q"):
        ...
        st=s@t, sDt=sD@t, stD=s@tD, sDtD=sD@tD, 
        tDsD=tD@sD, tDs=tD@s, tsD = t@sD, ts=t@s)
