...
# Hamiltonian parameters for the plane FxV given by (0, 3) x (-1.5, 1.5)
H_params = {
    'L': np.array([50]), 
...
def run(workers, simulation_path, parallel, use_cluster):
    ...
    if use_cluster == False:
        ...
        # U = 0
        fixed_values = {'name_1': 'L', 'value_1': 50, 'name_2': 'U', 'value_2': 0.0}
        Plotter.plot_topography(entropies, fixed_values, name_suffix='@entropy_UV_U00', cmap='coolwarm',
            title="Entanglement entropies of the UV plane")
        Plotter.plot_topography(charges, fixed_values, name_suffix='@charge_UV_U00',
