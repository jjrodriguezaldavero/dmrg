...
# Hamiltonian parameters for the point C2: (U, F) = (1, 1 + sqrt(3)) performing a cut along the F parameter
H_params = {
    #'L': np.array([64, 70, 76, 82, 88, 94, 100]), 
    'L': np.array([64, 70, 76, 82]), 
    'F': tools.compute_fss_range(central_value=(1 + np.sqrt(3)), n=8, delta=0.004),
    'U': np.array([1.0]),
    'V': np.array([0.0])
}
