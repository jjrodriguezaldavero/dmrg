...
H_params = {
    ...
    'L': np.array([4, 8]), 
    'F': tools.compute_fss_range(central_value=(0), n=4, delta=0.1),
    'U': tools.compute_fss_range(central_value=(0), n=4, delta=0.1),
    'V': np.array([0.0])
}
...
def run(workers, simulation_path, parallel, use_cluster):
    ...
    if use_cluster == False:
        ...
        fixed_value = {'name': 'V', 'value': 0}
        Plotter.plot_frustration_free_fit_2D(gaps[0], fixed_value, type='surface')
